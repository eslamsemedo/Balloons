              ...
              >
                <div className="rounded-2xl border bg-white shadow-sm overflow-hidden group">
                  ...
                  <div className="relative aspect-[3/3] w-full">
                    ...
                    />
                    {/* Rating pill */}
                    <div className="absolute right-3 top-3 flex items-center gap-1 rounded-full bg-white px-3 py-1 text-sm font-medium shadow">
                      {/* Star (inline SVG to avoid new imports) */}
                      <svg
                        viewBox="0 0 24 24"
                        aria-hidden="true"
                        className="h-4 w-4"
