"use client"
import { Carousel, iTestimonial, TestimonialCard } from "@/components/retro-testimonial";
      ...
      <section className="w-full bg-white md:padd">
        <div className="padd">
          ...
          <p className="text-gray-700 text-lg leading-relaxed">
            ...
            commentary and making your journey interesting and engaging. From the
            history and culture of the destinations you visit to the local customs
            and traditions, our guide will provide you with a wealth of
            information to enrich your travels.
          </p>
        </div>
